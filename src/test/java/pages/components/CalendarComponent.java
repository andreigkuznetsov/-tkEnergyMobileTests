...
public class CalendarComponent {
    ...
    private final SelenideElement calendarLink = $(MobileBy.id("ru.nrg_tk.mobileclient:id/Button_sending_date_ranges"));
    private final SelenideElement calendarWidgetHeader = $(MobileBy.id("ru.nrg_tk.mobileclient:id/mdtp_date_picker_header"));
